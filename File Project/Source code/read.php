        ...
        <div class="position-relative">
            <div class="container position-relative">
                ...
                <div class="row justify-content-center">
                    <h1 class="h2 bold-3 my-5 max-width-5x text-center">Jumlah Kamar Hotel yang Tersedia Tahun 2019 di Kabupaten Karangasem</h1>
                </div>
                <div class="content read">
                    ...
                    <div class="row my-4">
                        <div class="col-lg-5">
                            <a href="read2.php" class="btn btn-custom p-2 rounded shadow width-1n8x">Data sebaran Hotel</a>
                        </div>
                        <div class="col-lg-7">
                            <br>
